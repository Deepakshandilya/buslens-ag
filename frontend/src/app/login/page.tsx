                    ...
                    <div className="flex-1 flex flex-col justify-center pt-20 pb-8 px-6 sm:pt-12 sm:px-12 lg:p-14">
                        <div className="w-full max-w-sm mx-auto">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                                <div>
                                    <label htmlFor="login-email" className="block text-sm font-medium mb-2" style={{ color: "var(--auth-label)" }}>
                                        Email address
                                    </label>
                                ...
                                <div>
                                    <label htmlFor="login-password" className="block text-sm font-medium mb-2" style={{ color: "var(--auth-label)" }}>
                                        Password
                                    </label>
                                    <div className="relative">
